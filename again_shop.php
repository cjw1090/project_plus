        ...
        ?>
                ...
                <tbody id="list">
                        ...
                        <tr>
                                ...
                                <form method="get" action="review_list.php" style="display:inline;">
                                <input type="hidden" name="review_item" value="<?php echo $response['title']?>">
                                <button type="submit" class="btn btn-primary">리뷰</button>
                                </form></a>
                                <a href="login_input.php"><button type="button" onclick="button_click();" class="btn btn-primary">관심</button></a>
                                </div></td>
                        </tr>
