...
<!--Content Source-->
  ...
  <div class="container">
    <div class="main_margin">
      ...
      <form method="post" action="price.php" style="display:inline;">
      <input type="hidden" name="review_item" value="<?php echo $review_item; ?>">
      <button type="submit" class="btn btn-primary">최저가순</button>
          <!-- 
          <from action="review_list.php" method="post">
          <input class="btn btn-secondary" type="button" value="평점순" onclick="location.href='review_list.php'";>
          </from>-->
